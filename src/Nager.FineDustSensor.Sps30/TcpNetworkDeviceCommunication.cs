...
namespace Nager.FineDustSensor.Sps30
{
    ...
    public class TcpNetworkDeviceCommunication : IDeviceCommunication
    {
        ...
        private readonly TcpClient.TcpClient _tcpClient;
            ...
            ILogger<TcpNetworkDeviceCommunication>? logger = default)
        {
            ...
            if (enableKeepAlive)
            {
                var keepAliveConfig = new TcpClient.TcpClientKeepAliveConfig
                {
                    KeepAliveTime = 2,
                    KeepAliveInterval = 2,
                ...
                this._tcpClient = new TcpClient.TcpClient(keepAliveConfig: keepAliveConfig);
            }
            else
            {
                this._tcpClient = new TcpClient.TcpClient();
            }
